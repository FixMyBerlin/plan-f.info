...
const IndexPage: React.FC = () => {
  return (
    <Layout>
      ...
      <section className="mt-32 bg-pastel-purple px-layout">
        <div className="pt-8">
          ...
          <ul className="my-6 list-inside list-square">
            <li>
              ...
              gemeinsam vor Ort in Ihrer Kommune vom 17. bis 21. Oktober 2022
              mit Fahrradprofessorin Ineke Spapé und ihren Studierenden aus
              Breda (NL), dem Team vom AEM Institute sowie Studierenden aus
              Deutschland durchgeführt wird. Das Vorgehen orientiert sich an dem
        ...
        <div className="mt-8">
          <FoldOut>
            ...
            <p className="mt-6">
              ...
              stellt die Kommunalverwaltung kurz die wesentlichen Knackpunkte
              der Radverkehrsförderung vor. Die Studierenden bauen auf diesen
              auf und entwickeln eigene Visionen mit dem Ziel, die
              Fahrradmobilität in kurzer Zeit wesentlich zu verbessern – von der
              klassischen Planung bis zu Guerilla-Aktionen. Dabei wird
              Radverkehr grundsätzlich als Gesamtsystem gedacht – mit
              unterschiedlichen Zielgruppen, Handlungsfeldern und Maßnahmen, die
              weit über die einfache Infrastruktur hinausgehen.
            </p>
            <p>
              Die für Ihre Kommune maßgeschneiderten Ergebnisse der FreshBrains
              werden in einer Broschüre mit Planungen, Visualisierungen und
              Texten aufbereitet und am Ende der Woche der Stadtverwaltung sowie
      ...
      <section className="px-layout pt-12">
