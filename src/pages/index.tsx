          ...
          <div className="mt-8">
            ...
            <FoldOut>
              <p>
                ...
                Radmobilität in einem Gesamtsystem zu verbessern, ist es
            ...
            <FoldOut>
              <p>
                Um die Radmobilität langfristig zu erhöhen, ist es wichtig,
                Kinder und Jugendliche bereits früh mit der Nutzung des Fahrrads
                vertraut zu machen. Maßnahmen wie Mobilitätsbildung,
                Fahrradkurse oder Serviceangebote z. B. zur Reparatur, in
                Schulen, Kitas oder Jugendclubs tragen dazu bei, dass das
                Fahrrad ein selbstverständlicher Bestandteil der
                Mobilitätskultur wird. Aber auch für Erwachsene sind Bildungs-
                und Trainingsangebote wichtig. Es gibt viele Personen, die nicht
                Fahrradfahren, weil sie es nie gelernt haben oder sich, z. B.
                mit zunehmendem Alter, unsicher fühlen. (Weiter-) Bildung
                beinhaltet zudem nicht nur das Erlernen des Fahrradfahrens,
                sondern auch die Vermittlung der Vorteile des Radfahrens sowohl
                für Jugendliche als auch für ältere Menschen.
              </p>
            </FoldOut>
            <H2>Infrastruktur</H2>
            <FoldOut>
              Das Handlungsfeld Infrastruktur schließt alle Maßnahmen ein, die
              der Verbesserung der Radinfrastrukturanlagen dienen. Dabei geht es
              um den fließenden Radverkehr, z. B. Radwege, Einrichtung von
              ...
              Verkehr. Um die Nutzbarkeit der Radmobilität für alle Zielgruppen
              zu erhöhen, muss eine geeignete Radinfrastruktur so ausgelegt
              sein, dass sich alle Personen sicher fühlen. Infrastrukturen, um
              die Multimodalität zu fördern, sind im Handlungsfeld 6
              „Multimodalität und Nahmobilität“ aufgeführt.
            </FoldOut>
            <H2>Kommunikation und Öffentlichkeitsarbeit</H2>
            <FoldOut>
              <p>
                Das Handlungsfeld Kommunikation und Öffentlichkeitsarbeit
                schließt alle Maßnahmen ein, die das Fahrrad als Verkehrsmittel
                bewerben und wichtige Informationen, zum Beispiel zu
                radverkehrsbezogenen Angeboten oder neue sowie weniger bekannte
                Verkehrsregeln, verbreiten. Dazu gehören z. B. Maßnahmen wie
                Kampagnen und Veranstaltungen sowie einfache Pressemitteilungen.
                Kommunen können sich auch ein Branding als „Fahrradstadt“
                auferlegen und darüber hinaus selbst als Vorbilder auftreten,
                beispielsweise durch eine Zertifizierung der Kommunalverwaltung
            ...
            <FoldOut>
              <p>
                Radverkehrsbezogene Serviceangebote, wie Reparaturstationen
                sowie Bike- Sharing oder verschiedene Apps (z. B. zur
                Routenführung oder Ampelschaltung), sind wichtige Bausteine, um
                den Radverkehr zu fördern und zugänglicher zu gestalten.
              </p>
            </FoldOut>
            ...
            <FoldOut>
              <p>
                ...
                alles darum, den Radverkehr besser mit anderen Verkehrsmitteln
                zu verknüpfen sowie in Einklang mit anderen Formen der
                Nahmobilität zu bringen. Multimodalität kann beispielsweise
                durch Maßnahmen verbessert werden, welche die Mitnahme des
                Fahrrads in öffentlichen Verkehrsmitteln oder den Umstieg (Bike
                & Ride, Mobility Hubs, Abstellanlagen an ÖPNV- Haltestellen
                etc.) zu anderen Verkehrsmitteln erleichtern. Zusätzlich ist es
                wichtig, geeignete Maßnahmen umzusetzen, die ein gutes
                Miteinander der verschiedenen Nahmobilitätsformen (Fußverkehr,
                Radverkehr, E-Scooter) fördern.
              </p>
            </FoldOut>
            <H2>Wirtschaft</H2>
            <FoldOut>
              ...
              Maßnahmen, die den Kundenverkehr im Einzelhandel adressieren und
              die Radmobilität diesbezüglich fördern (z. B. durch bestimmte
              Vorgaben, wie z. B. Stellplatzschlüssel für Fahrräder).
            </FoldOut>
            ...
            <FoldOut>
              ...
              Informationen als auch Fördermöglichkeiten für die
              Privatwirtschaft (z. B. Abstellanlagen oder E-Ladestationen) oder
              Bike Parks.
            </FoldOut>
          ...
          <div>
            ...
            <div>
              ...
              <FoldOut>
                <p>
                  ...
                  Quantität der Radinfrastruktur erhöht, so dass die
                  Attraktivität und Bedeutung des Radverkehrs als Mobilitätsform
                  für den Alltag steigen.
                </p>
                <p>
                  Der Zweckverband hat dafür ein regionales Radverkehrskonzept
                  erstellt, welches in den kommenden Jahren umgesetzt werden
                  soll. Ziel ist es, durch die interkommunale
                  Radverkehrsförderung eine Alternative zum Pkw zu schaffen und
                  die Lebensqualität in der Region zu verbessern. Die Stärke des
                  entstehenden regionalen Radverkehrsnetzes liegt dabei sowohl
                  in der Schaffung von Synergien zwischen dem Alltagsverkehr und
                  touristischen Routen als auch in einer engen Verzahnung des
                  Radverkehrs mit anderen Verkehrsträgern und
                  Mobilitätskonzepten.
                </p>
                <QuoteBox>
                  Der Zweckverband LANDFOLGE Garzweiler belegt mit dem
                  Rheinischen Radverkehrsrevier den 3. Platz (Gesamtwertung) des
                  Plan F Awards 2022 und hat das Plan F Online-Audit in einem
              ...
              <FoldOut>
                ...
                Nachrüstung von Fahrradabstellanlagen im Bestand. Darauf
                aufbauend hat Hamburg ein Förderprogramm aufgelegt, das den
                formulierten Anspruch an die Qualität der Anlagen in die
                Umsetzung bringt.
                {/* TODO: media */}
              </FoldOut>
              <H3>
              ...
              <FoldOut>
                <p>
                  ...
                  sowie Dialog und Vernetzung. Fahrradmobilität soll damit
                  soziale Teilhabe ermöglichen.
                </p>
              </FoldOut>
            </div>
            <div>
              ...
              <FoldOut>
                ...
                Frühjahr 2021 im Landkreis Osnabrück Schüler*innen ab der
                fünften Klasse sowie das Schulpersonal motiviert, ihre Schulwege
                mit dem Rad zurückzulegen. Die App-basierte Kampagne rief dazu
                auf, Teams zu bilden und mit dem Rad zur Schule zu fahren. Die
                mit der App aufgezeichneten Schulradfahrten generierten für das
                Team und die Schule Punkte, die in einem Ranking in der App
                dargestellt wurden. Dabei wurde technisch sichergestellt, dass
                nur Radfahrten zur Schule in die Punkteberechnung einflossen.
                Punkte-Booster für das Team verbesserten die Platzierung: Fuhr
                das gesamte Team häufig Fahrrad, wurde das mit Boostern belohnt.
                Durch diesen spielerischen Ansatz motivierten eifrige
                Teilnehmer*innen ihre Teammitglieder zum häufigeren Radfahren.
                Gleichzeitig lag der Fokus nicht auf reinem Kilometersammeln,
                sondern auf regelmäßigen Fahrten, um möglichst viele Personen
                zur Teilnahme zu motivieren. Am Ende erhielten die
                bestplatzierten Schulen Geldpreise, die für die Anschaffung von
                z. B. Spiel- oder Sportgeräten für die Schüler*innen genutzt
                werden können.
                {/* Todo:media */}
              </FoldOut>
              ...
              <FoldOut>
                <p>
                  ...
                  kurz vor den Sommerferien mit allen fünften Klassen jeweils
                  eine Aktion durchgeführt, um solchen Radfahr-Geschichten auf
                  die Spur zu kommen. Dabei wurde unter anderem deutlich, dass
                  die Schüler*innen das Rad hauptsächlich in der Freizeit und
                  weniger im Alltag nutzen.
                </p>
                <p>
              ...
              <FoldOut>
                <p>
                  ...
                  Stadtentwicklung, -planung und Mobilitätsinfrastruktur der
                  Stadt Aachen bietet seit dem Schulhalbjahr 2015/2016 eine
                  umfangreiche Mobilitäts- und Verkehrserziehung für
                  Grundschüler*innen auf dem Gelände der Feuerwehr Aachen an. In
                  dem sogenannten Floriansdorf lernen Kinder, was im
                  Straßenverkehr wichtig ist: Ganz allgemein werden
                  Informationen über Verkehrszeichen, verkehrssicheres Fahrrad
                  und zu dem Verhalten und genereller Sicherheit im
                  Straßenverkehr vermittelt. Es gibt verschiedene Übungen wie
                  Spurgassen, Ballsport, Rampen, Wippen, Kreisel,
                  Schneckenrennen und Vieles mehr, mit denen die Kinder mit viel
                  Spaß das Fahrradfahren im Floriansdorf üben. Zusätzlich gibt
                  es auch theoretischen Unterricht Ganz allgemein werden
                  Informationen über Verkehrszeichen, verkehrssicheres Fahrrad
                  und zu dem Verhalten und genereller Sicherheit im
                  Straßenverkehr vermittelt unter anderem zu Abbiegesituationen.
                </p>
                <p>
                  Damit die Kinder einen Eindruck vom Straßenverkehr bekommen,
                  hat die Stadtverwaltung in dem Schonraum auf dem
                  Feuerwehrgelände Verkehrsschilder aufgestellt und Radwege
                  sowie Aufstellflächen markiert. Außerdem steht seit diesem
                  Jahr eine Ampelanlage zur Verfügung.
                </p>
                {/* TODO: media */}
              </FoldOut>
            </div>
            <div>
              ...
              <FoldOut>
                <p>
                  Mobilität soll für alle sein, deshalb hat die Gemeinde
                  Wallmerod den ersten barrierefreien Radweg in Rheinland-Pfalz
                  gebaut. Ob auf dem Fahrrad, im Rollstuhl oder mit Kinderwagen,
                  jede*r soll die Möglichkeit bekommen, sich frei und
                  klimaneutral bewegen zu können. Gerade im ländlichen Raum, wo
                  die Radwege eher mit Schotterwegen in Verbindung gebracht
                  werden, ist dies eine großartige Möglichkeit, sich aktiv für
                  den Klimaschutz einzusetzen. Der Wäller ALLEen-Weg erstreckt
                  sich über eine Länge von 12 km und verbindet dabei zwei
                  Verbandsgemeinden und verschiedenste Arbeitgeber*innen, sodass
                  eine Alltagstauglichkeit gegeben ist. Spezielle
                  Beschilderungen und Rastplatzanlagen laden Menschen mit und
                  ohne Einschränkungen ein, die klimaneutrale Fortbewegung
                  fernab vom Pkw-Verkehr zu genießen.
                </p>
                <QuoteBox>
                ...
                <p>
                  In einem kurzen Video beantwortet die Verbandsgemeinde die
                  drei häufigsten Fragen zu dem neuen Radweg:
              ...
              <FoldOut>
                <p>
                  ...
                  ausgestattet sind. An mehreren freilaufenden Rechtsabbiegern
                  ist es in der Vergangenheit häufig zu Konflikten und Unfällen
                  mit nicht- motorisierten Verkehrsteilnehmer*innen zum Teil mit
                  ...
                  verkehrssicher umgestaltet. Das eigens erstellte
                  Baukastensystem enthält eine Vielzahl von Maßnahmen die kurz-,
                  mittel- oder langfristig anwendbar sind und dadurch die
                  Planer*innen beim Umbau unterstützen.
                </p>
              </FoldOut>
              <H3>3. Erfurt: Südknoten</H3>
              <QuoteBox>
                <p>
                  Der Erfurter Südknoten ist ein komplexer Verkehrsknoten,
                  welcher dem Generalverkehrsplan von 1968 entstammt. Heute
                  kreuzen dort zwei Bundesstraßen, die wiederum zwei Autobahnen
                  verknüpfen. Die Ziele der ursprünglichen Verkehrsplanung
                  richteten sich auf einen störungsfreien und leistungsstarken
                  Kfz-Verkehr aus. Die Belange des Rad- und Fußverkehrs sind
                  nicht mitgedacht, die Führung entspricht bei weitem nicht den
                  heutigen Standards. Aus diesem Grund wurde eine neue,
                  barrierefreie oberirdische Fußgänger-Querung errichtet und
                  barrierefreie, direkte und übersichtliche Wege über den Knoten
                  für Radfahrende geschaffen. Gleichzeitig wurde Platz für eine
                  zukünftige Stadtbahnline geschaffen und somit die
                  Verkehrssituation an die Anforderungen des 21. Jahrhunderts
                  angepasst.
                </p>
                {/* TODO: media */}
              </QuoteBox>
            ...
            <div>
              ...
              <FoldOut>
                <p>
                  ...
                  die Stadt Aachen angenommen mit dem Ziel der Umsetzung bis
                  2027. Die Umsetzung des Radentscheids erfordert, den
                  Straßenraum grundlegend neu aufzuteilen. Der Radentscheid
                  eröffnet damit die Chance, Stadt zu gestalten und Potentiale
                  der Nachhaltigkeit im öffentlichen Raum zu heben. Ein
                  permanenter Baustein dabei ist die Kommunikation zu aktuellen
                  Meilensteinen, Herausforderungen und zur Zielerreichung. Dafür
                  gibt es neben einem regelmäßigen Austausch zwischen dem Team
                  des Radentscheids und der Stadt, jährlichen
                  Tätigkeitsberichten und Kampagnen auch eine
                ...
                <QuoteBox>
                  ...
                  Radentscheid den 2. Platz (Gesamtwertung) des Plan F Awards
                  2022 und hat das Plan F Online-Audit gewonnen.
                </QuoteBox>
                <p>
              ...
              <FoldOut>
                <p>
                  ...
                  Bürgermeisterin. Dieses immer weiter ausgebaute Programm
                  bietet seit 2017 die Stadt Oberursel an und zeigt
                  gleichzeitig, welches Potential die Stadt für Radfahrer*innen
                  bietet. Mittlerweile werden Neubürger*innen zu einer von drei
                  möglichen Radtouren eingeladen, bei der sie die Stadt und
                  deren Radwege kennenlernen können. Zudem bieten die Radtouren
                  die Gelegenheit, andere Neubürger*innen zu treffen. Die Stadt
                  nutzt dabei diese besondere Möglichkeit, den Radverkehr zu
                  stärken, denn Lebensumbrüche, wie z.B. ein Umzug, bieten die
                  Chance, eingeübte Verhaltensweisen zu verändern.
                </p>
                {/* TODO: media */}
              </FoldOut>
              ...
              <FoldOut>
                <p>
                  Ein Kaffee für 25 km oder eine Eintrittskarte für 60km? Mit
                  der App „DB Rad+“ der Deutschen Bahn kann man jetzt
                  Fahrrad-Kilometer sammeln und bei Partner*innen in der Stadt
                  gegen Belohnungen eintauschen. Und je mehr in die Pedale
                  treten, desto mehr lohnt es sich für alle Radfahrer*innen in
                  Wiesbaden. Seit einem Jahr wird die App in Kooperation mit
                  @deutschebahn angeboten. In dieser Zeit wurden fast 100.000
                  Routen aufgezeichnet, 428.000 Kilometer gesammelt und 2.320
                  Prämien eingelöst. Wer mit der App Kilometer sammelt, kann sie
                  gegen Rabatte bei Partner*innen einlösen oder einen
                  Cappuccino, einen Apfel oder auch den Eintritt ins Museum
                  Wiesbaden bezahlen.
                </p>
              </FoldOut>
            </div>
            <div>
              ...
              <QuoteBox>
                <p>
                  Die Stadt hat insgesamt 50 Fahrradservicestationen
                  eingerichtet, welche Radfahrende unterwegs die Möglichkeit
                  geben, kleine Reparaturen an ihren Fahrrädern zu erledigen.
                  Die kleinen Do-it-yourself-Stationen bieten Werkzeuge, eine
                  Luftpumpe und eine Fahrradhalterung. Die Gelsenkirchener*innen
                  können diese Servicestationen an fast sämtlichen Tankstellen
                  im Stadtgebiet sowie weiteren Standorten finden.
                </p>
                <p>
              ...
              <FoldOut>
                <p>
                  Radwegweiser werden leider nicht regelmäßig gewartet – das
                  führt zu Fehlinformationen für Radfahrende!
                </p>
                <p>
                  ...
                  Dienststelle weiterleitet, damit diese schnellst behoben
                  werden.
                </p>
                {/* TODO */}
              </FoldOut>
              ...
              <FoldOut>
                <p>
                  ...
                  gestartet! Alle Kaufunger*innen können sich nun kostenlos
                  eines der 17 Lastenräder ausleihen und damit alles Mögliche
                ...
                <p>
                  ...
                  kleinere und größere Transporte erledigen oder Kinder und
                  sogar Erwachsene chauffieren!
                </p>
                <p>
                  Die Flotte besteht aus: 10 einspurigen Lastenrädern, 3
                  dreispurigen Schwerlastenrädern, 2 Rikschas, 1 zweisitziges
                  vierrädriges Schwerlastenrad (noch nicht im Verleih), 1
                  Gespann bestehend aus einspurigem Lastenrad und einem
                  dreispurigen Schwerlast- Anhänger (Der Anhänger kann auch als
            ...
            <div>
              ...
              <p>
                ...
                ausgewählt. Für den ersten Platz hat es bei beiden Projekten
                noch an kleineren Punkten gefehlt.
              </p>
              ...
              <FoldOut>
                <p>
                  ...
                  unkompliziert, ohne große Suche nach einem Parkplatz, ganz
                  ohne Fahrradschloss und trotzdem gut gesichert: So können
                  Fahrräder und Pedelecs seit Dezember 2021 am Fellbacher
                  Bahnhof abgestellt werden. Denn in der „Fellbach.go! radbox“,
                  dem neuen Fahrradparkhaus, finden 76 Räder einen trockenen
                  Abstellplatz – und das ganz automatisch. Nutzer*innen müssen
                  dafür nur die App auf ihrem Smartphone bedienen. Das Projekt
                  wurde mit Mitteln des Europäischen Fonds für
                  Regionalentwicklung (EFRE) und des Landes Baden-Württemberg
                  gefördert. Kooperationspartner im Rahmen des RegioWIN-Projekts
                  „Regionale Mobilitätspunkte“ sind der Verband Region Stuttgart
                  (VRS), der Verkehrsverbund Stuttgart (VVS) und die Stadt
                  Fellbach.
                </p>
              </FoldOut>
              ...
              <FoldOut>
                <p>
                  ...
                  Verknüpfung zwischen Fahrrad und öffentlichen Verkehrsmitteln
                  zu fördern und intermodale Wegeketten zu stärken.
                </p>
                <p>
                  Der Verkehrsverbund Rhein-Neckar hat eigene abschließbare
                  Fahrradboxen inklusive Ladevorrichtung für E-Bikes
                  aufgestellt. Die VRNradboxen sollen künftig auf das gesamte
                  VRN-Gebiet ausgeweitet werden. Nutzende werden online über die
                  aktuelle Auslastung informiert, der Zugang erfolgt über ein
                  eigenes Buchungssystem. So kann das Fahrrad trocken und sicher
                  am Bahnhof abgestellt werden.
                </p>
              </FoldOut>
            </div>
            <div>
              <H2>Wirtschaft</H2>
              <p>
                Im Handlungsfeld Wirtschaft haben wir keine Einreichung
                erhalten, die unsere Jury mit dem Plan F Award auszeichnen
                wollte.
              </p>
              <H2>Tourismus und Freizeitverkehr</H2>
              ...
              <FoldOut>
                <p>
                  Bei dieser werden genau wie bei einer klassischen
                  Schnitzeljagd Hinweise verfolgt, um am Ende das Ziel zu
                  erreichen – nur eben mit dem Fahrrad. Die Morsbacher
                  Fahrrad-Schnitzeljagd fand im Zeitraum der Aktion STADTRADELN
                  vom 4. Bis 24. September 2022 statt.
                </p>
                <p>
                  Um an der Fahrrad-Schnitzeljagd teilzunehmen, brauchte es
                  lediglich ein verkehrssicheres Fahrrad und eine Prise
                  Entdeckerdrang! Die Teilnehmer*innen hatten die Aufgabe,
                  entlang der eigens angelegten Route die Stationsschilder zu
                  finden. Die Schilder waren während des gesamten
                  Aktionszeitraums angebracht und verrieten nicht nur einen Teil
                  des zu lösenden Wortpuzzles, sondern auch den Weg zur nächsten
                  Station. Wer die Wortpuzzleteile in die richtige Reihenfolge
                  brachte, erhielt mit etwas Geschick das Lösungswort. Unter
                  allen Teilnehmer*innen wurden am Ende der Aktion tolle Preise
                  verlost, die von lokalen Betrieben gesponsert wurden.
                </p>
              </FoldOut>
              ...
              <FoldOut>
                <p>
                  ...
                  kann die 110 km lange Rundtour vom Zentrum aus erreicht und
                  von wenig bis sehr ambitionierten Radfahrenden in einer oder
                  mehreren Etappen bewältigt werden.
                </p>
                <p>
                  Mit geringem baulichem und finanziellem Aufwand wurde eine
                  neue Freizeitroute geschaffen, die der einheimischen
                  Bevölkerung neue Blickwinkel auf ihre Stadt eröffnet und
                  zugleich den thüringischen Tourismus stärken soll. Darüber
                  hinaus profitiert auch der Alltagsradverkehr, denn der Rundweg
                  schafft eine gute Anbindung der angrenzenden Landkreise an die
                  Stadt Erfurt!
                </p>
              </FoldOut>
            </div>
            <div>
              ...
              <FoldOut>
                <p>
                  Zur Reduzierung des MIV in der Neusser Innenstadt hat die
                  Stadt verschiedene Erschließungsstraßen im Rahmen eines
                  neunmonatigen Verkehrsversuches in Fahrradstraßen umgewandelt.
                  Die neue Fahrradachse durch die Innenstadt soll den Radverkehr
                  fördern und die Verkehrssicherheit insbesondere für
              ...
              <FoldOut>
                <p>
                  ...
                  aller Generationen in der Innenstadt zu ermöglichen. Dafür
                  wurde vier Straßen und ein Knotenpunkt in der Innenstadt
                  umgestaltet. Die Fahrbahn und Nebenanlagen wurden optisch
                  einheitlich gestaltet und lediglich durch die
                  Straßenausstattung getrennt. In Verbindung mit den reduzierten
                  Geschwindigkeiten wird so eine Begegnungszone in der
                  Innenstadt von Friesoythe geschaffen.
                </p>
                <p>
                  Für Strecken, die nicht mit dem Rad zu bewältigen sind, wird
                  der kreisweite Carsharing-Dienst moobil+ angeboten.
                </p>
                <p>
                  Interessierte Anwohner*innen haben sich frühzeitig in den
                  Planungsprozess eingebracht. Im Ergebnis führte dieses zu
                  einer Art Mix aus Geschäftsstraße und Fußgänger*innenzone. Die
                  intensive Beteiligung des Beirates für Menschen mit
                  Beeinträchtigungen spiegelt sich in der gestalterischen
                  Umsetzung wider, welche versucht den verschiedenen Belangen
                  der Barrierefreiheit nachzukommen. Durch den Verzicht auf
                  Bordsteine erfährt die Innenstadt ein einheitliches
                  Erscheinungsbild. Es wurden Leitlinien durch
                  Kleinpflasterstreifen sowie taktile Elemente an
                  Überquerungsstellen eingesetzt, welche wichtige
        ...
        <Content>
          <div>
            ...
            <p>
              ...
              unterschiedlichen Handlungsfeldern werden zudem in unserem
              Handbuch sowie auf der Webseite von Plan F veröffentlicht. Die
              guten Beispiele aus der kommunalen Praxis sollen die vielfältigen
              Handlungsmöglichkeiten in der Radverkehrsförderung
            ...
            <H3>Plan F Check:</H3>
            <H2>
              Passgenaue Handlungsempfehlungen durch Selbstevaluation von
              Kommunen
            </H2>
            <p>
              ...
              entwickelt. Dieser ist voraussichtlich ab Sommer 2023 über die
              Plan F Webseite abrufbar.
            </p>
            <p>
              ...
              können? Schreiben Sie uns gern eine E-Mail dazu an
            </p>
