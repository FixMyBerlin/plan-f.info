...
type TopicMeasureExamplesQuery = { readonly topics: { readonly nodes: ReadonlyArray<{ readonly name: string | null, readonly shortDescription: string | null, readonly slug: string | null, readonly image: { readonly url: string | null } | null, readonly measures: ReadonlyArray<{ readonly name: string | null, readonly slug: string | null, readonly shortDescription: string | null, readonly examples: ReadonlyArray<{ readonly position: number | null, readonly title: string | null, readonly shortDescription: string | null, readonly subcategory: string | null, readonly slug: string | null, readonly financiallyWeak: boolean | null, readonly beginnerFriendly: boolean | null, readonly population: string | null, readonly spatialStructure: string | null, readonly countryState: string | null, readonly measure: { readonly name: string | null, readonly slug: string | null } | null, readonly image: { readonly copyright: string | null, readonly image: { readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null> | null } | null> | null }> } };
...
type TopicTeasersQuery = { readonly topics: { readonly nodes: ReadonlyArray<{ readonly slug: string | null, readonly name: string | null, readonly shortDescription: string | null, readonly image: { readonly url: string | null } | null }> } };
