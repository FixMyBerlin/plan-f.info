  ...
  return (
    <div
      className={clsx(
        ...
        'lg:prose-h1:mb-6 lg:prose-h1:mt-0 lg:prose-h2:mt-1 lg:prose-h2:mb-6 lg:prose-h3:mt-4 lg:prose-h3:mb-6 lg:prose-p:mt-2 lg:prose-p:mb-2', // p & heading margins for desktop
