...
export const planfProseClasses = clsx(
  ...
  // H2
  'prose-h2:mb-5 prose-h2:md:leading-normal prose-h2:leading-snug prose-h2:mt-8 prose-h2:font-mono prose-h2:text-xl prose-h2:font-normal prose-h2:text-black prose-h2:md:mb-10 prose-h2:md:mt-10 prose-h2:md:text-3xl',
  // H3
