      ...
      {linkList.map((item) => (
        <li key={item.name}>
          <Link
            ...
            className="block font-apercuMono text-lg leading-5 text-stone-50 decoration-stone-400 decoration-1 underline-offset-2 hover:text-white hover:decoration-white"
          >
            {item.name}
          </Link>
        </li>
